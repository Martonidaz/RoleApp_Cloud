...
// --- NOVO: Rota segura para Imagens (Proxy) ---
// Isso faz o link com a função nova que criamos no controller
router.get('/api/foto', core.getFotoProxy); 
// ----------------------------------------------
...
// Rota de Configuração (O Frontend vai chamar isso para pegar a chave do mapa)
